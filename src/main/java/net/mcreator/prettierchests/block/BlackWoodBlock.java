...
public class BlackWoodBlock extends PrettierchestsModElements.ModElement {
	@ObjectHolder("prettierchests:black_wood")
	public static final Block block = null;
	public BlackWoodBlock(PrettierchestsModElements instance) {
		super(instance, 65);
	}
