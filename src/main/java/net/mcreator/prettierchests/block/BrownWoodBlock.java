...
public class BrownWoodBlock extends PrettierchestsModElements.ModElement {
	@ObjectHolder("prettierchests:brown_wood")
	public static final Block block = null;
	public BrownWoodBlock(PrettierchestsModElements instance) {
		super(instance, 70);
	}
