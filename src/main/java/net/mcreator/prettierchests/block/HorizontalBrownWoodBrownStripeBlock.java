...
public class HorizontalBrownWoodBrownStripeBlock extends PrettierchestsModElements.ModElement {
	@ObjectHolder("prettierchests:horizontal_brown_wood_brown_stripe")
	public static final Block block = null;
	public HorizontalBrownWoodBrownStripeBlock(PrettierchestsModElements instance) {
		super(instance, 179);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("horizontal_brown_wood_brown_stripe");
		}
