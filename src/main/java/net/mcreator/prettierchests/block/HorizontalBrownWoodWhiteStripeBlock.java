...
public class HorizontalBrownWoodWhiteStripeBlock extends PrettierchestsModElements.ModElement {
	@ObjectHolder("prettierchests:horizontal_brown_wood_white_stripe")
	public static final Block block = null;
	public HorizontalBrownWoodWhiteStripeBlock(PrettierchestsModElements instance) {
		super(instance, 172);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("horizontal_brown_wood_white_stripe");
		}
