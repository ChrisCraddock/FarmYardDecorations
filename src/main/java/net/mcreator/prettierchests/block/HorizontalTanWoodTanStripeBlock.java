...
public class HorizontalTanWoodTanStripeBlock extends PrettierchestsModElements.ModElement {
	@ObjectHolder("prettierchests:horizontal_tan_wood_tan_stripe")
	public static final Block block = null;
	public HorizontalTanWoodTanStripeBlock(PrettierchestsModElements instance) {
		super(instance, 177);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("horizontal_tan_wood_tan_stripe");
		}
