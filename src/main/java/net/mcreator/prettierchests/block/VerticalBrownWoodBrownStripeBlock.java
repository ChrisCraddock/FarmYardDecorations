...
public class VerticalBrownWoodBrownStripeBlock extends PrettierchestsModElements.ModElement {
	@ObjectHolder("prettierchests:vertical_brown_wood_brown_stripe")
	public static final Block block = null;
	public VerticalBrownWoodBrownStripeBlock(PrettierchestsModElements instance) {
		super(instance, 181);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("vertical_brown_wood_brown_stripe");
		}
