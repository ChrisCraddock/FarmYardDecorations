...
public class VerticalBrownWoodWhiteStripeBlock extends PrettierchestsModElements.ModElement {
	@ObjectHolder("prettierchests:vertical_brown_wood_white_stripe")
	public static final Block block = null;
	public VerticalBrownWoodWhiteStripeBlock(PrettierchestsModElements instance) {
		super(instance, 173);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("vertical_brown_wood_white_stripe");
		}
