...
public class VerticalTanWoodBrownStripeBlock extends PrettierchestsModElements.ModElement {
	@ObjectHolder("prettierchests:vertical_tan_wood_brown_stripe")
	public static final Block block = null;
	public VerticalTanWoodBrownStripeBlock(PrettierchestsModElements instance) {
		super(instance, 174);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("vertical_tan_wood_brown_stripe");
		}
