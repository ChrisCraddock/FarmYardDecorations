...
public class VerticalTanWoodTanStripeBlock extends PrettierchestsModElements.ModElement {
	@ObjectHolder("prettierchests:vertical_tan_wood_tan_stripe")
	public static final Block block = null;
	public VerticalTanWoodTanStripeBlock(PrettierchestsModElements instance) {
		super(instance, 176);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("vertical_tan_wood_tan_stripe");
		}
