...
public class VerticalTanWoodWhiteStripeBlock extends PrettierchestsModElements.ModElement {
	@ObjectHolder("prettierchests:vertical_tan_wood_white_stripe")
	public static final Block block = null;
	public VerticalTanWoodWhiteStripeBlock(PrettierchestsModElements instance) {
		super(instance, 180);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("vertical_tan_wood_white_stripe");
		}
