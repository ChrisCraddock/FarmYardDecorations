...
public class Slot0ClearAllItemsProcedure {
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				PrettierchestsMod.LOGGER.warn("Failed to load dependency entity for procedure Slot0ClearAllItems!");
			return;
		}
		...
		if (entity instanceof ServerPlayerEntity) {
			...
			if (_current instanceof Supplier) {
				Object invobj = ((Supplier) _current).get();
				if (invobj instanceof Map) {
					((Slot) ((Map) invobj).get((int) (30))).putStack(ItemStack.EMPTY);
					_current.detectAndSendChanges();
				}
			}
		}
		...
		if (entity instanceof ServerPlayerEntity) {
			...
			if (_current instanceof Supplier) {
				Object invobj = ((Supplier) _current).get();
				if (invobj instanceof Map) {
					((Slot) ((Map) invobj).get((int) (37))).putStack(ItemStack.EMPTY);
					_current.detectAndSendChanges();
				}
			}
		}
